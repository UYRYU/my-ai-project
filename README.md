...
|---|---|---|---|
| BTCUSDT | 2.73 | [4.11, 1.67, 2.42] | ◯ Fold 2 が弱い |
| ETHUSDT | **5.17** | [6.24, 4.99, 4.27] | ⭐最高PF |
| DOGEUSDT | 3.17 | [2.90, 3.68, 2.93] | ◎ 最安定 |
| XRPUSDT | 3.30 | [3.08, 3.52, 3.32] | ◎ 安定 |
| **ポートフォリオ (等重み)** | — | — | **Sharpe 8.96 (個別最高 8.70 を超える)** |

**シンボル間の相関 (合成データ)**:
- シグナル同時発火相関 0.01-0.08 (ほぼ独立)
- 平均同時保有 1.91 シンボル / 4
- 月次リターン相関 mixed (BTC×DOGE=-0.48 で分散効果大)
→ **4シンボル分散運用**でリスク調整後リターンが最も良くなる
